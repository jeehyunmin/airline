...
@Log
public class DateDelayReducer extends Reducer<DateComplexKey, Text, DateComplexKey, Text> {
	...
	@Override
	protected void reduce(DateComplexKey key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
